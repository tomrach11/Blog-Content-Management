...
INSERT INTO user (username, password, firstname, lastname, email, phone, enable) values 
	("admin", "password", "Tom", "Rachtawarn", "tomrach11@gmail.com", "347318000", true),
    ("content1", "password", "John", "Doe", "johnD@gmail.com", "34784595846", true),
    ("content2", "password", "Marry", "Jane", "marryJ@gmail.com", "92947859621", true),
    ("user1", "password", "Willaim", "Smith", "will@gmail.com", "347318000", true),
    ("user2", "password", "Jay", "Won", "jwon@gmail.com", "347318000", true),
    ("user3", "password", "kavin", "Stones", "kavstone@gmail.com", "347318000", true);
